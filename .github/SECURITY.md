...
1. Navigate to [Report a Vulnerability](https://github.com/hyperpolymath/patch-bridge/security/advisories/new)
...
- This repository (`hyperpolymath/patch-bridge`) and all its code
