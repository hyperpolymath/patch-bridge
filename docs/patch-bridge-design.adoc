...
*Audit note (2026-03-30)*: This document is aspirational. References
below to proofs, formal verification, lifecycle automation, and upstream
integration describe intended architecture unless separately evidenced
by checked artefacts in the repository.
